        ...
        <el-form :ref="form" v-model="formProps" label-width="80px">
          ...
          <el-form-item label="商品价格" prop="price">
            <el-input-number
              ...
              v-model="formProps.minPrice"
              placeholder="最低价格"
            />
            <span> - </span>
            <el-input-number
              :min="formProps.minPrice || 0"
              v-model="formProps.maxPrice"
              placeholder="最高价格"
            />
          </el-form-item>
          <el-form-item label="商品销量" prop="sold">
            <el-input-number
              :min="0"
              :max="formProps.maxSold"
              v-model="formProps.minSold"
              placeholder="最低销量"
            />
            <span> - </span>
            <el-input-number
              :min="formProps.minSold || 0"
              v-model="formProps.maxSold"
              placeholder="最高销量"
            />
          </el-form-item>
        </el-form>
