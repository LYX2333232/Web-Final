...
<template>
  <el-card>
    <el-row>
      <el-card
        :span="4"
        class="w-70 border-2 border-yellow-400 mx-10 my-5 h-100 flex flex-col"
      ...
      >
        ...
        <div style="display: flex; justify-content: space-evenly; align-items: center">
          <span class="mx-5 whitespace-nowrap overflow-hidden overflow-ellipsis">{{
            item.name
          }}</span>
