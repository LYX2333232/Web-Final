...
<template>
    <div style="display: flex; justifyContent: space-between;">
        <span>共有<span class="text-red-600">{{ num }}</span>件商品，总计<span class="text-red-600">{{ total }}</span>元</span>
        <el-button type="primary" @click="">结算</el-button>
    </div>
    <el-row>
        <el-col :span="4" class="border-2 border-yellow-400 mx-10 my-5 h-80" v-for="item in dataList" :key="item.id">
